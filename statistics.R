...
####################################################################################
#Standard t-test
ttestPretty <-function(x,y=NULL,mu=0, var.equal=T, paired=F, maxBF = 100,bonferroni=1){
  ...
  p <- pformat(p.adjust(freq$p.value,'bonferroni',bonferroni))
...
corTestPretty <-function(x,y, maxBF = 100, method = 'pearson',bonferroni=1){
